...
- [Telegram (Bot API)](https://docs.openclaw.ai/channels/telegram#telegram-bot-api)
- [Quick setup (beginner)](https://docs.openclaw.ai/channels/telegram#quick-setup-beginner)
- [What it is](https://docs.openclaw.ai/channels/telegram#what-it-is)
- [Setup (fast path)](https://docs.openclaw.ai/channels/telegram#setup-fast-path)
- [1) Create a bot token (BotFather)](https://docs.openclaw.ai/channels/telegram#1-create-a-bot-token-botfather)
- [2) Configure the token (env or config)](https://docs.openclaw.ai/channels/telegram#2-configure-the-token-env-or-config)
- [Token + privacy + permissions (Telegram side)](https://docs.openclaw.ai/channels/telegram#token-%2B-privacy-%2B-permissions-telegram-side)
- [Token creation (BotFather)](https://docs.openclaw.ai/channels/telegram#token-creation-botfather)
- [Group message visibility (Privacy Mode)](https://docs.openclaw.ai/channels/telegram#group-message-visibility-privacy-mode)
- [Group permissions (admin rights)](https://docs.openclaw.ai/channels/telegram#group-permissions-admin-rights)
- [How it works (behavior)](https://docs.openclaw.ai/channels/telegram#how-it-works-behavior)
- [Formatting (Telegram HTML)](https://docs.openclaw.ai/channels/telegram#formatting-telegram-html)
- [Commands (native + custom)](https://docs.openclaw.ai/channels/telegram#commands-native-%2B-custom)
- [Troubleshooting](https://docs.openclaw.ai/channels/telegram#troubleshooting)
- [Limits](https://docs.openclaw.ai/channels/telegram#limits)
- [Group activation modes](https://docs.openclaw.ai/channels/telegram#group-activation-modes)
- [Via config (recommended)](https://docs.openclaw.ai/channels/telegram#via-config-recommended)
- [Via command (session-level)](https://docs.openclaw.ai/channels/telegram#via-command-session-level)
- [Getting the group chat ID](https://docs.openclaw.ai/channels/telegram#getting-the-group-chat-id)
- [Config writes](https://docs.openclaw.ai/channels/telegram#config-writes)
- [Topics (forum supergroups)](https://docs.openclaw.ai/channels/telegram#topics-forum-supergroups)
- [Inline Buttons](https://docs.openclaw.ai/channels/telegram#inline-buttons)
- [Sending buttons](https://docs.openclaw.ai/channels/telegram#sending-buttons)
- [Configuration options](https://docs.openclaw.ai/channels/telegram#configuration-options)
- [Access control (DMs + groups)](https://docs.openclaw.ai/channels/telegram#access-control-dms-%2B-groups)
- [DM access](https://docs.openclaw.ai/channels/telegram#dm-access)
- [Finding your Telegram user ID](https://docs.openclaw.ai/channels/telegram#finding-your-telegram-user-id)
- [Group access](https://docs.openclaw.ai/channels/telegram#group-access)
- [Long-polling vs webhook](https://docs.openclaw.ai/channels/telegram#long-polling-vs-webhook)
- [Reply threading](https://docs.openclaw.ai/channels/telegram#reply-threading)
- [Audio messages (voice vs file)](https://docs.openclaw.ai/channels/telegram#audio-messages-voice-vs-file)
- [Stickers](https://docs.openclaw.ai/channels/telegram#stickers)
- [Receiving stickers](https://docs.openclaw.ai/channels/telegram#receiving-stickers)
- [Sticker cache](https://docs.openclaw.ai/channels/telegram#sticker-cache)
- [Sending stickers](https://docs.openclaw.ai/channels/telegram#sending-stickers)
- [Streaming (drafts)](https://docs.openclaw.ai/channels/telegram#streaming-drafts)
- [Retry policy](https://docs.openclaw.ai/channels/telegram#retry-policy)
- [Agent tool (messages + reactions)](https://docs.openclaw.ai/channels/telegram#agent-tool-messages-%2B-reactions)
- [Reaction notifications](https://docs.openclaw.ai/channels/telegram#reaction-notifications)
- [Delivery targets (CLI/cron)](https://docs.openclaw.ai/channels/telegram#delivery-targets-cli%2Fcron)
- [Troubleshooting](https://docs.openclaw.ai/channels/telegram#troubleshooting-2)
- [Configuration reference (Telegram)](https://docs.openclaw.ai/channels/telegram#configuration-reference-telegram)

# [​](https://docs.openclaw.ai/channels/telegram\#telegram-bot-api)  Telegram (Bot API)

Status: production-ready for bot DMs + groups via grammY. Long-polling by default; webhook optional.

## [​](https://docs.openclaw.ai/channels/telegram\#quick-setup-beginner)  Quick setup (beginner)
...
## [​](https://docs.openclaw.ai/channels/telegram\#what-it-is)  What it is
...
## [​](https://docs.openclaw.ai/channels/telegram\#setup-fast-path)  Setup (fast path)

### [​](https://docs.openclaw.ai/channels/telegram\#1-create-a-bot-token-botfather)  1) Create a bot token (BotFather)
...
### [​](https://docs.openclaw.ai/channels/telegram\#2-configure-the-token-env-or-config)  2) Configure the token (env or config)
...
## [​](https://docs.openclaw.ai/channels/telegram\#token-+-privacy-+-permissions-telegram-side)  Token + privacy + permissions (Telegram side)

### [​](https://docs.openclaw.ai/channels/telegram\#token-creation-botfather)  Token creation (BotFather)
...
### [​](https://docs.openclaw.ai/channels/telegram\#group-message-visibility-privacy-mode)  Group message visibility (Privacy Mode)
...
### [​](https://docs.openclaw.ai/channels/telegram\#group-permissions-admin-rights)  Group permissions (admin rights)
...
## [​](https://docs.openclaw.ai/channels/telegram\#how-it-works-behavior)  How it works (behavior)
...
## [​](https://docs.openclaw.ai/channels/telegram\#formatting-telegram-html)  Formatting (Telegram HTML)
...
## [​](https://docs.openclaw.ai/channels/telegram\#commands-native-+-custom)  Commands (native + custom)
...
## [​](https://docs.openclaw.ai/channels/telegram\#troubleshooting)  Troubleshooting
...
More help: [Channel troubleshooting](https://docs.openclaw.ai/channels/troubleshooting).Notes:
...
## [​](https://docs.openclaw.ai/channels/telegram\#limits)  Limits
...
## [​](https://docs.openclaw.ai/channels/telegram\#group-activation-modes)  Group activation modes
...
### [​](https://docs.openclaw.ai/channels/telegram\#via-config-recommended)  Via config (recommended)
...
### [​](https://docs.openclaw.ai/channels/telegram\#via-command-session-level)  Via command (session-level)
...
### [​](https://docs.openclaw.ai/channels/telegram\#getting-the-group-chat-id)  Getting the group chat ID

Forward any message from the group to `@userinfobot` or `@getidsbot` on Telegram to see the chat ID (negative number like `-1001234567890`).**Tip:** For your own user ID, DM the bot and it will reply with your user ID (pairing message), or use `/whoami` once commands are enabled.**Privacy note:**`@userinfobot` is a third-party bot. If you prefer, add the bot to the group, send a message, and use `openclaw logs --follow` to read `chat.id`, or use the Bot API `getUpdates`.

## [​](https://docs.openclaw.ai/channels/telegram\#config-writes)  Config writes
...
## [​](https://docs.openclaw.ai/channels/telegram\#topics-forum-supergroups)  Topics (forum supergroups)
...
## [​](https://docs.openclaw.ai/channels/telegram\#inline-buttons)  Inline Buttons
...
### [​](https://docs.openclaw.ai/channels/telegram\#sending-buttons)  Sending buttons
...
### [​](https://docs.openclaw.ai/channels/telegram\#configuration-options)  Configuration options
...
## [​](https://docs.openclaw.ai/channels/telegram\#access-control-dms-+-groups)  Access control (DMs + groups)

### [​](https://docs.openclaw.ai/channels/telegram\#dm-access)  DM access
...
- Pairing is the default token exchange used for Telegram DMs. Details: [Pairing](https://docs.openclaw.ai/start/pairing)
...
### [​](https://docs.openclaw.ai/channels/telegram\#group-access)  Group access
...
## [​](https://docs.openclaw.ai/channels/telegram\#long-polling-vs-webhook)  Long-polling vs webhook
...
## [​](https://docs.openclaw.ai/channels/telegram\#reply-threading)  Reply threading
...
## [​](https://docs.openclaw.ai/channels/telegram\#audio-messages-voice-vs-file)  Audio messages (voice vs file)

Telegram distinguishes **voice notes** (round bubble) from **audio files** (metadata card).
OpenClaw defaults to audio files for backward compatibility.To force a voice note bubble in agent replies, include this tag anywhere in the reply:
...
## [​](https://docs.openclaw.ai/channels/telegram\#stickers)  Stickers

OpenClaw supports receiving and sending Telegram stickers with intelligent caching.

### [​](https://docs.openclaw.ai/channels/telegram\#receiving-stickers)  Receiving stickers
...
### [​](https://docs.openclaw.ai/channels/telegram\#sticker-cache)  Sticker cache

Stickers are processed through the AI’s vision capabilities to generate descriptions. Since the same stickers are often sent repeatedly, OpenClaw caches these descriptions to avoid redundant API calls.**How it works:**
...
**Cache location:**`~/.openclaw/telegram/sticker-cache.json`**Cache entry format:**
...
### [​](https://docs.openclaw.ai/channels/telegram\#sending-stickers)  Sending stickers
...
## [​](https://docs.openclaw.ai/channels/telegram\#streaming-drafts)  Streaming (drafts)
...
More context: [Streaming + chunking](https://docs.openclaw.ai/concepts/streaming).

## [​](https://docs.openclaw.ai/channels/telegram\#retry-policy)  Retry policy

Outbound Telegram API calls retry on transient network/429 errors with exponential backoff and jitter. Configure via `channels.telegram.retry`. See [Retry policy](https://docs.openclaw.ai/concepts/retry).

## [​](https://docs.openclaw.ai/channels/telegram\#agent-tool-messages-+-reactions)  Agent tool (messages + reactions)
...
## [​](https://docs.openclaw.ai/channels/telegram\#reaction-notifications)  Reaction notifications
...
## [​](https://docs.openclaw.ai/channels/telegram\#delivery-targets-cli/cron)  Delivery targets (CLI/cron)

- Use a chat id (`123456789`) or a username (`@name`) as the target.
- Example: `openclaw message send --channel telegram --target 123456789 --message "hi"`.

## [​](https://docs.openclaw.ai/channels/telegram\#troubleshooting-2)  Troubleshooting
...
## [​](https://docs.openclaw.ai/channels/telegram\#configuration-reference-telegram)  Configuration reference (Telegram)
...
[Whatsapp](https://docs.openclaw.ai/channels/whatsapp) [Grammy](https://docs.openclaw.ai/channels/grammy)
