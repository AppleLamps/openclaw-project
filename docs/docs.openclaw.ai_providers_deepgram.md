...
# [​](https://docs.openclaw.ai/providers/deepgram\#deepgram-audio-transcription)  Deepgram (Audio Transcription)

Deepgram is a speech-to-text API. In OpenClaw it is used for **inbound audio/voice note**
**transcription** via `tools.media.audio`.When enabled, OpenClaw uploads the audio file to Deepgram and injects the transcript
into the reply pipeline (`{{Transcript}}` \+ `[Audio]` block). This is **not streaming**;
it uses the pre-recorded transcription endpoint.Website: [https://deepgram.com](https://deepgram.com/)

Docs: [https://developers.deepgram.com](https://developers.deepgram.com/)

## [​](https://docs.openclaw.ai/providers/deepgram\#quick-start)  Quick start
...
## [​](https://docs.openclaw.ai/providers/deepgram\#options)  Options
