...
- [macOS permissions (TCC)](https://docs.openclaw.ai/platforms/mac/permissions#macos-permissions-tcc)
...
# [​](https://docs.openclaw.ai/platforms/mac/permissions\#macos-permissions-tcc)  macOS permissions (TCC)
...
[Logging](https://docs.openclaw.ai/platforms/mac/logging) [Remote](https://docs.openclaw.ai/platforms/mac/remote)
