...
- [Setup (fast path)](https://docs.openclaw.ai/channels/signal#setup-fast-path)
...
## [​](https://docs.openclaw.ai/channels/signal\#setup-fast-path)  Setup (fast path)
...
- Pairing is the default token exchange for Signal DMs. Details: [Pairing](https://docs.openclaw.ai/start/pairing)
