...
- [Control UI (browser)](https://docs.openclaw.ai/web/control-ui#control-ui-browser)
...
- [Integrated Tailscale Serve (preferred)](https://docs.openclaw.ai/web/control-ui#integrated-tailscale-serve-preferred)
- [Bind to tailnet + token](https://docs.openclaw.ai/web/control-ui#bind-to-tailnet-%2B-token)
...
- [Debugging/testing: dev server + remote Gateway](https://docs.openclaw.ai/web/control-ui#debugging%2Ftesting%3A-dev-server-%2B-remote-gateway)

# [​](https://docs.openclaw.ai/web/control-ui\#control-ui-browser)  Control UI (browser)
...
### [​](https://docs.openclaw.ai/web/control-ui\#integrated-tailscale-serve-preferred)  Integrated Tailscale Serve (preferred)
...
### [​](https://docs.openclaw.ai/web/control-ui\#bind-to-tailnet-+-token)  Bind to tailnet + token
...
OpenClaw **blocks** Control UI connections without device identity.**Recommended fix:** use HTTPS (Tailscale Serve) or open the UI locally:
...
only if you trust the network.See [Tailscale](https://docs.openclaw.ai/gateway/tailscale) for HTTPS setup guidance.
