...
[Skip to main content](https://docs.openclaw.ai/index#content-area)
...
- [OpenClaw 🦞](https://docs.openclaw.ai/index#openclaw-%F0%9F%A6%9E)
- [Start here](https://docs.openclaw.ai/index#start-here)
- [Dashboard (browser Control UI)](https://docs.openclaw.ai/index#dashboard-browser-control-ui)
- [How it works](https://docs.openclaw.ai/index#how-it-works)
- [Network model](https://docs.openclaw.ai/index#network-model)
- [Features (high level)](https://docs.openclaw.ai/index#features-high-level)
- [Quick start](https://docs.openclaw.ai/index#quick-start)
- [Configuration (optional)](https://docs.openclaw.ai/index#configuration-optional)
- [Docs](https://docs.openclaw.ai/index#docs)
- [The name](https://docs.openclaw.ai/index#the-name)
- [Credits](https://docs.openclaw.ai/index#credits)
- [Core Contributors](https://docs.openclaw.ai/index#core-contributors)
- [License](https://docs.openclaw.ai/index#license)

# [​](https://docs.openclaw.ai/index\#openclaw-%F0%9F%A6%9E)  OpenClaw 🦞
...
## [​](https://docs.openclaw.ai/index\#start-here)  Start here
...
## [​](https://docs.openclaw.ai/index\#dashboard-browser-control-ui)  Dashboard (browser Control UI)
...
## [​](https://docs.openclaw.ai/index\#how-it-works)  How it works
...
## [​](https://docs.openclaw.ai/index\#network-model)  Network model
...
## [​](https://docs.openclaw.ai/index\#features-high-level)  Features (high level)
...
## [​](https://docs.openclaw.ai/index\#quick-start)  Quick start
...
## [​](https://docs.openclaw.ai/index\#configuration-optional)  Configuration (optional)
...
## [​](https://docs.openclaw.ai/index\#docs)  Docs

- Start here:
  - [Docs hubs (all pages linked)](https://docs.openclaw.ai/start/hubs)
  - [Help](https://docs.openclaw.ai/help) ← _common fixes + troubleshooting_
...
## [​](https://docs.openclaw.ai/index\#the-name)  The name
...
## [​](https://docs.openclaw.ai/index\#license)  License
