...
- [Plugin required](https://docs.openclaw.ai/channels/zalo#plugin-required)
...
# [​](https://docs.openclaw.ai/channels/zalo\#zalo-bot-api)  Zalo (Bot API)

Status: experimental. Direct messages only; groups coming soon per Zalo docs.

## [​](https://docs.openclaw.ai/channels/zalo\#plugin-required)  Plugin required
...
[Matrix](https://docs.openclaw.ai/channels/matrix) [Zalouser](https://docs.openclaw.ai/channels/zalouser)
