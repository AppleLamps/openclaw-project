...
# [​](https://docs.openclaw.ai/providers/venice\#venice-ai-venice-highlight)  Venice AI (Venice highlight)
...
## [​](https://docs.openclaw.ai/providers/venice\#setup)  Setup

### [​](https://docs.openclaw.ai/providers/venice\#1-get-api-key)  1\. Get API Key

1. Sign up at [venice.ai](https://venice.ai/)
2. Go to **Settings → API Keys → Create new key**
3. Copy your API key (format: `vapi_xxxxxxxxxxxx`)

### [​](https://docs.openclaw.ai/providers/venice\#2-configure-openclaw)  2\. Configure OpenClaw
...
### [​](https://docs.openclaw.ai/providers/venice\#3-verify-setup)  3\. Verify Setup
...
## [​](https://docs.openclaw.ai/providers/venice\#configure-via-openclaw-configure)  Configure via `openclaw configure`

1. Run `openclaw configure`
2. Select **Model/auth**
3. Choose **Venice AI**

## [​](https://docs.openclaw.ai/providers/venice\#which-model-should-i-use)  Which Model Should I Use?
...
## [​](https://docs.openclaw.ai/providers/venice\#available-models-25-total)  Available Models (25 Total)

### [​](https://docs.openclaw.ai/providers/venice\#private-models-15-%E2%80%94-fully-private,-no-logging)  Private Models (15) — Fully Private, No Logging
...
### [​](https://docs.openclaw.ai/providers/venice\#anonymized-models-10-%E2%80%94-via-venice-proxy)  Anonymized Models (10) — Via Venice Proxy
...
## [​](https://docs.openclaw.ai/providers/venice\#streaming-&-tool-support)  Streaming & Tool Support
...
## [​](https://docs.openclaw.ai/providers/venice\#comparison:-venice-vs-direct-api)  Comparison: Venice vs Direct API
...
### [​](https://docs.openclaw.ai/providers/venice\#api-key-not-recognized)  API key not recognized
...
### [​](https://docs.openclaw.ai/providers/venice\#model-not-available)  Model not available
...
### [​](https://docs.openclaw.ai/providers/venice\#connection-issues)  Connection issues

Venice API is at `https://api.venice.ai/api/v1`. Ensure your network allows HTTPS connections.

## [​](https://docs.openclaw.ai/providers/venice\#config-file-example)  Config file example
...
## [​](https://docs.openclaw.ai/providers/venice\#links)  Links
