...
- [Tool summary redaction](https://docs.openclaw.ai/gateway/logging#tool-summary-redaction)
...
## [​](https://docs.openclaw.ai/gateway/logging\#tool-summary-redaction)  Tool summary redaction
...
[Doctor](https://docs.openclaw.ai/gateway/doctor) [Security](https://docs.openclaw.ai/gateway/security)
