...
- [OpenClaw macOS Companion (menu bar + gateway broker)](https://docs.openclaw.ai/platforms/macos#openclaw-macos-companion-menu-bar-%2B-gateway-broker)
...
- [openclaw://agent](https://docs.openclaw.ai/platforms/macos#openclaw%3A%2F%2Fagent)
...
# [​](https://docs.openclaw.ai/platforms/macos\#openclaw-macos-companion-menu-bar-+-gateway-broker)  OpenClaw macOS Companion (menu bar + gateway broker)
...
Replace the label with `bot.molt.<profile>` when running a named profile.If the LaunchAgent isn’t installed, enable it from the app or run
...
[Platforms](https://docs.openclaw.ai/platforms) [Macos vm](https://docs.openclaw.ai/platforms/macos-vm)
