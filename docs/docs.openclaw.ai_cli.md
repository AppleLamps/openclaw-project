...
- [CLI reference](https://docs.openclaw.ai/cli#cli-reference)
- [Command pages](https://docs.openclaw.ai/cli#command-pages)
- [Global flags](https://docs.openclaw.ai/cli#global-flags)
- [Output styling](https://docs.openclaw.ai/cli#output-styling)
- [Color palette](https://docs.openclaw.ai/cli#color-palette)
...
- [Setup + onboarding](https://docs.openclaw.ai/cli#setup-%2B-onboarding)
...
- [Channel helpers](https://docs.openclaw.ai/cli#channel-helpers)
...
- [webhooks gmail](https://docs.openclaw.ai/cli#webhooks-gmail)
- [dns setup](https://docs.openclaw.ai/cli#dns-setup)
- [Messaging + agent](https://docs.openclaw.ai/cli#messaging-%2B-agent)
- [message](https://docs.openclaw.ai/cli#message)
- [agent](https://docs.openclaw.ai/cli#agent)
- [agents](https://docs.openclaw.ai/cli#agents)
- [agents list](https://docs.openclaw.ai/cli#agents-list)
- [agents add \[name\]](https://docs.openclaw.ai/cli#agents-add-%5Bname%5D)
- [agents delete <id>](https://docs.openclaw.ai/cli#agents-delete-%3Cid%3E)
...
- [Reset / Uninstall](https://docs.openclaw.ai/cli#reset-%2F-uninstall)
...
- [gateway](https://docs.openclaw.ai/cli#gateway-2)
- [gateway service](https://docs.openclaw.ai/cli#gateway-service)
- [logs](https://docs.openclaw.ai/cli#logs)
- [gateway <subcommand>](https://docs.openclaw.ai/cli#gateway-%3Csubcommand%3E)
- [Models](https://docs.openclaw.ai/cli#models)
- [models (root)](https://docs.openclaw.ai/cli#models-root)
- [models list](https://docs.openclaw.ai/cli#models-list)
- [models status](https://docs.openclaw.ai/cli#models-status)
- [models set <model>](https://docs.openclaw.ai/cli#models-set-%3Cmodel%3E)
- [models set-image <model>](https://docs.openclaw.ai/cli#models-set-image-%3Cmodel%3E)
- [models aliases list\|add\|remove](https://docs.openclaw.ai/cli#models-aliases-list%7Cadd%7Cremove)
- [models fallbacks list\|add\|remove\|clear](https://docs.openclaw.ai/cli#models-fallbacks-list%7Cadd%7Cremove%7Cclear)
- [models image-fallbacks list\|add\|remove\|clear](https://docs.openclaw.ai/cli#models-image-fallbacks-list%7Cadd%7Cremove%7Cclear)
- [models scan](https://docs.openclaw.ai/cli#models-scan)
- [models auth add\|setup-token\|paste-token](https://docs.openclaw.ai/cli#models-auth-add%7Csetup-token%7Cpaste-token)
- [models auth order get\|set\|clear](https://docs.openclaw.ai/cli#models-auth-order-get%7Cset%7Cclear)
- [System](https://docs.openclaw.ai/cli#system)
- [system event](https://docs.openclaw.ai/cli#system-event)
- [system heartbeat last\|enable\|disable](https://docs.openclaw.ai/cli#system-heartbeat-last%7Cenable%7Cdisable)
- [system presence](https://docs.openclaw.ai/cli#system-presence)
- [Cron](https://docs.openclaw.ai/cli#cron)
- [Node host](https://docs.openclaw.ai/cli#node-host)
- [Nodes](https://docs.openclaw.ai/cli#nodes)
- [Browser](https://docs.openclaw.ai/cli#browser)
- [Docs search](https://docs.openclaw.ai/cli#docs-search)
- [docs \[query...\]](https://docs.openclaw.ai/cli#docs-%5Bquery-%5D)
- [TUI](https://docs.openclaw.ai/cli#tui)
- [tui](https://docs.openclaw.ai/cli#tui-2)

# [​](https://docs.openclaw.ai/cli\#cli-reference)  CLI reference
...
## [​](https://docs.openclaw.ai/cli\#output-styling)  Output styling
...
## [​](https://docs.openclaw.ai/cli\#color-palette)  Color palette
...
## [​](https://docs.openclaw.ai/cli\#security)  Security

- `openclaw security audit` — audit config + local state for common security foot-guns.
- `openclaw security audit --deep` — best-effort live Gateway probe.
- `openclaw security audit --fix` — tighten safe defaults and chmod state/config.

## [​](https://docs.openclaw.ai/cli\#plugins)  Plugins
...
## [​](https://docs.openclaw.ai/cli\#memory)  Memory
...
## [​](https://docs.openclaw.ai/cli\#setup-+-onboarding)  Setup + onboarding

### [​](https://docs.openclaw.ai/cli\#setup)  `setup`
...
### [​](https://docs.openclaw.ai/cli\#onboard)  `onboard`
...
### [​](https://docs.openclaw.ai/cli\#configure)  `configure`

Interactive configuration wizard (models, channels, skills, gateway).

### [​](https://docs.openclaw.ai/cli\#config)  `config`
...
### [​](https://docs.openclaw.ai/cli\#doctor)  `doctor`
...
## [​](https://docs.openclaw.ai/cli\#channel-helpers)  Channel helpers

### [​](https://docs.openclaw.ai/cli\#channels)  `channels`
...
### [​](https://docs.openclaw.ai/cli\#skills)  `skills`
...
### [​](https://docs.openclaw.ai/cli\#pairing)  `pairing`
...
### [​](https://docs.openclaw.ai/cli\#webhooks-gmail)  `webhooks gmail`
...
### [​](https://docs.openclaw.ai/cli\#dns-setup)  `dns setup`
...
## [​](https://docs.openclaw.ai/cli\#messaging-+-agent)  Messaging + agent

### [​](https://docs.openclaw.ai/cli\#message)  `message`
...
#### [​](https://docs.openclaw.ai/cli\#agents-list)  `agents list`
...
#### [​](https://docs.openclaw.ai/cli\#agents-add-[name])  `agents add [name]`
...
#### [​](https://docs.openclaw.ai/cli\#agents-delete-%3Cid%3E)  `agents delete <id>`
...
### [​](https://docs.openclaw.ai/cli\#status)  `status`
...
### [​](https://docs.openclaw.ai/cli\#health)  `health`
...
### [​](https://docs.openclaw.ai/cli\#sessions)  `sessions`
...
## [​](https://docs.openclaw.ai/cli\#reset-/-uninstall)  Reset / Uninstall

### [​](https://docs.openclaw.ai/cli\#reset)  `reset`
...
## [​](https://docs.openclaw.ai/cli\#gateway)  Gateway

### [​](https://docs.openclaw.ai/cli\#gateway-2)  `gateway`
...
### [​](https://docs.openclaw.ai/cli\#gateway-service)  `gateway service`
...
### [​](https://docs.openclaw.ai/cli\#logs)  `logs`
...
### [​](https://docs.openclaw.ai/cli\#gateway-%3Csubcommand%3E)  `gateway <subcommand>`
...
## [​](https://docs.openclaw.ai/cli\#models)  Models
...
### [​](https://docs.openclaw.ai/cli\#models-root)  `models` (root)
...
### [​](https://docs.openclaw.ai/cli\#models-list)  `models list`
...
### [​](https://docs.openclaw.ai/cli\#models-status)  `models status`
...
### [​](https://docs.openclaw.ai/cli\#models-set-%3Cmodel%3E)  `models set <model>`

Set `agents.defaults.model.primary`.

### [​](https://docs.openclaw.ai/cli\#models-set-image-%3Cmodel%3E)  `models set-image <model>`

Set `agents.defaults.imageModel.primary`.

### [​](https://docs.openclaw.ai/cli\#models-aliases-list|add|remove)  `models aliases list|add|remove`
...
### [​](https://docs.openclaw.ai/cli\#models-fallbacks-list|add|remove|clear)  `models fallbacks list|add|remove|clear`
...
### [​](https://docs.openclaw.ai/cli\#models-image-fallbacks-list|add|remove|clear)  `models image-fallbacks list|add|remove|clear`
...
### [​](https://docs.openclaw.ai/cli\#models-scan)  `models scan`
...
### [​](https://docs.openclaw.ai/cli\#models-auth-add|setup-token|paste-token)  `models auth add|setup-token|paste-token`
...
### [​](https://docs.openclaw.ai/cli\#models-auth-order-get|set|clear)  `models auth order get|set|clear`
...
## [​](https://docs.openclaw.ai/cli\#system)  System

### [​](https://docs.openclaw.ai/cli\#system-event)  `system event`
...
### [​](https://docs.openclaw.ai/cli\#system-heartbeat-last|enable|disable)  `system heartbeat last|enable|disable`
...
### [​](https://docs.openclaw.ai/cli\#system-presence)  `system presence`
...
## [​](https://docs.openclaw.ai/cli\#cron)  Cron
...
## [​](https://docs.openclaw.ai/cli\#node-host)  Node host
...
## [​](https://docs.openclaw.ai/cli\#nodes)  Nodes
...
## [​](https://docs.openclaw.ai/cli\#browser)  Browser
...
## [​](https://docs.openclaw.ai/cli\#docs-search)  Docs search

### [​](https://docs.openclaw.ai/cli\#docs-[query-])  `docs [query...]`

Search the live docs index.

## [​](https://docs.openclaw.ai/cli\#tui)  TUI

### [​](https://docs.openclaw.ai/cli\#tui-2)  `tui`
