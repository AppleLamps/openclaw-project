...
title: "Openresponses http api - OpenClaw"
---
...
# [​](https://docs.openclaw.ai/gateway/openresponses-http-api\#openresponses-api-http)  OpenResponses API (HTTP)
...
## [​](https://docs.openclaw.ai/gateway/openresponses-http-api\#authentication)  Authentication
...
## [​](https://docs.openclaw.ai/gateway/openresponses-http-api\#choosing-an-agent)  Choosing an agent
...
## [​](https://docs.openclaw.ai/gateway/openresponses-http-api\#enabling-the-endpoint)  Enabling the endpoint
...
## [​](https://docs.openclaw.ai/gateway/openresponses-http-api\#disabling-the-endpoint)  Disabling the endpoint
