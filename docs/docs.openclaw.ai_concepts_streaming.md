...
- [Streaming + chunking](https://docs.openclaw.ai/concepts/streaming#streaming-%2B-chunking)
...
- [“Stream chunks or everything”](https://docs.openclaw.ai/concepts/streaming#%E2%80%9Cstream-chunks-or-everything%E2%80%9D)
- [Telegram draft streaming (token-ish)](https://docs.openclaw.ai/concepts/streaming#telegram-draft-streaming-token-ish)

# [​](https://docs.openclaw.ai/concepts/streaming\#streaming-+-chunking)  Streaming + chunking
...
## [​](https://docs.openclaw.ai/concepts/streaming\#%E2%80%9Cstream-chunks-or-everything%E2%80%9D)  “Stream chunks or everything”
...
**Channel note:** For non-Telegram channels, block streaming is **off unless**`*.blockStreaming` is explicitly set to `true`. Telegram can stream drafts
(`channels.telegram.streamMode`) without block replies.Config location reminder: the `blockStreaming*` defaults live under
`agents.defaults`, not the root config.

## [​](https://docs.openclaw.ai/concepts/streaming\#telegram-draft-streaming-token-ish)  Telegram draft streaming (token-ish)
...
[Messages](https://docs.openclaw.ai/concepts/messages) [Markdown formatting](https://docs.openclaw.ai/concepts/markdown-formatting)
