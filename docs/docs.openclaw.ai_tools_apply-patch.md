...
# [​](https://docs.openclaw.ai/tools/apply-patch\#apply_patch-tool)  apply\_patch tool
...
[Web](https://docs.openclaw.ai/tools/web) [Elevated](https://docs.openclaw.ai/tools/elevated)
