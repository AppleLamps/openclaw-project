...
- [Socket mode (default)](https://docs.openclaw.ai/channels/slack#socket-mode-default)
- [Quick setup (beginner)](https://docs.openclaw.ai/channels/slack#quick-setup-beginner)
- [Setup](https://docs.openclaw.ai/channels/slack#setup)
- [OpenClaw config (minimal)](https://docs.openclaw.ai/channels/slack#openclaw-config-minimal)
- [User token (optional)](https://docs.openclaw.ai/channels/slack#user-token-optional)
- [Token usage](https://docs.openclaw.ai/channels/slack#token-usage)
- [History context](https://docs.openclaw.ai/channels/slack#history-context)
- [HTTP mode (Events API)](https://docs.openclaw.ai/channels/slack#http-mode-events-api)
- [Setup](https://docs.openclaw.ai/channels/slack#setup-2)
- [OpenClaw config (minimal)](https://docs.openclaw.ai/channels/slack#openclaw-config-minimal-2)
- [Manifest (optional)](https://docs.openclaw.ai/channels/slack#manifest-optional)
- [Scopes (current vs optional)](https://docs.openclaw.ai/channels/slack#scopes-current-vs-optional)
- [Bot token scopes (required)](https://docs.openclaw.ai/channels/slack#bot-token-scopes-required)
- [User token scopes (optional, read-only by default)](https://docs.openclaw.ai/channels/slack#user-token-scopes-optional%2C-read-only-by-default)
- [Not needed today (but likely future)](https://docs.openclaw.ai/channels/slack#not-needed-today-but-likely-future)
- [Config](https://docs.openclaw.ai/channels/slack#config)
- [Limits](https://docs.openclaw.ai/channels/slack#limits)
- [Reply threading](https://docs.openclaw.ai/channels/slack#reply-threading)
- [Per-chat-type threading](https://docs.openclaw.ai/channels/slack#per-chat-type-threading)
- [Manual threading tags](https://docs.openclaw.ai/channels/slack#manual-threading-tags)
- [Sessions + routing](https://docs.openclaw.ai/channels/slack#sessions-%2B-routing)
- [DM security (pairing)](https://docs.openclaw.ai/channels/slack#dm-security-pairing)
- [Group policy](https://docs.openclaw.ai/channels/slack#group-policy)
- [Delivery targets](https://docs.openclaw.ai/channels/slack#delivery-targets)
- [Tool actions](https://docs.openclaw.ai/channels/slack#tool-actions)
- [Security notes](https://docs.openclaw.ai/channels/slack#security-notes)
- [Notes](https://docs.openclaw.ai/channels/slack#notes)

# [​](https://docs.openclaw.ai/channels/slack\#slack)  Slack

## [​](https://docs.openclaw.ai/channels/slack\#socket-mode-default)  Socket mode (default)

### [​](https://docs.openclaw.ai/channels/slack\#quick-setup-beginner)  Quick setup (beginner)
...
### [​](https://docs.openclaw.ai/channels/slack\#setup)  Setup
...
### [​](https://docs.openclaw.ai/channels/slack\#user-token-optional)  User token (optional)
...
preferred for writes when it is available.User tokens are configured in the config file (no env var support). For
multi-account, set `channels.slack.accounts.<id>.userToken`.Example with bot + app + user tokens:
...
#### [​](https://docs.openclaw.ai/channels/slack\#token-usage)  Token usage
...
### [​](https://docs.openclaw.ai/channels/slack\#history-context)  History context

- `channels.slack.historyLimit` (or `channels.slack.accounts.*.historyLimit`) controls how many recent channel/group messages are wrapped into the prompt.
- Falls back to `messages.groupChat.historyLimit`. Set `0` to disable (default 50).

## [​](https://docs.openclaw.ai/channels/slack\#http-mode-events-api)  HTTP mode (Events API)
...
### [​](https://docs.openclaw.ai/channels/slack\#setup-2)  Setup
...
### [​](https://docs.openclaw.ai/channels/slack\#openclaw-config-minimal-2)  OpenClaw config (minimal)
...
### [​](https://docs.openclaw.ai/channels/slack\#manifest-optional)  Manifest (optional)
...
## [​](https://docs.openclaw.ai/channels/slack\#scopes-current-vs-optional)  Scopes (current vs optional)
...
### [​](https://docs.openclaw.ai/channels/slack\#bot-token-scopes-required)  Bot token scopes (required)
...
[https://docs.slack.dev/reference/methods/reactions.get](https://docs.slack.dev/reference/methods/reactions.get) [https://docs.slack.dev/reference/methods/reactions.add](https://docs.slack.dev/reference/methods/reactions.add)
- `pins:read`, `pins:write` (`pins.list` / `pins.add` / `pins.remove`)
[https://docs.slack.dev/reference/scopes/pins.read](https://docs.slack.dev/reference/scopes/pins.read) [https://docs.slack.dev/reference/scopes/pins.write](https://docs.slack.dev/reference/scopes/pins.write)
...
### [​](https://docs.openclaw.ai/channels/slack\#user-token-scopes-optional,-read-only-by-default)  User token scopes (optional, read-only by default)
...
### [​](https://docs.openclaw.ai/channels/slack\#not-needed-today-but-likely-future)  Not needed today (but likely future)
...
## [​](https://docs.openclaw.ai/channels/slack\#config)  Config
...
## [​](https://docs.openclaw.ai/channels/slack\#limits)  Limits
...
## [​](https://docs.openclaw.ai/channels/slack\#reply-threading)  Reply threading
...
### [​](https://docs.openclaw.ai/channels/slack\#per-chat-type-threading)  Per-chat-type threading
...
### [​](https://docs.openclaw.ai/channels/slack\#manual-threading-tags)  Manual threading tags
...
## [​](https://docs.openclaw.ai/channels/slack\#sessions-+-routing)  Sessions + routing
...
## [​](https://docs.openclaw.ai/channels/slack\#dm-security-pairing)  DM security (pairing)
...
## [​](https://docs.openclaw.ai/channels/slack\#group-policy)  Group policy
...
## [​](https://docs.openclaw.ai/channels/slack\#delivery-targets)  Delivery targets
...
## [​](https://docs.openclaw.ai/channels/slack\#tool-actions)  Tool actions
...
## [​](https://docs.openclaw.ai/channels/slack\#security-notes)  Security notes
...
## [​](https://docs.openclaw.ai/channels/slack\#notes)  Notes
...
- For the Slack tool, reaction removal semantics are in [/tools/reactions](https://docs.openclaw.ai/tools/reactions).
- Attachments are downloaded to the media store when permitted and under the size limit.

[Discord](https://docs.openclaw.ai/channels/discord) [Googlechat](https://docs.openclaw.ai/channels/googlechat)
