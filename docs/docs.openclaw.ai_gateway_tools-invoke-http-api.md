...
# [​](https://docs.openclaw.ai/gateway/tools-invoke-http-api\#tools-invoke-http)  Tools Invoke (HTTP)
...
## [​](https://docs.openclaw.ai/gateway/tools-invoke-http-api\#authentication)  Authentication
...
## [​](https://docs.openclaw.ai/gateway/tools-invoke-http-api\#request-body)  Request body
...
## [​](https://docs.openclaw.ai/gateway/tools-invoke-http-api\#policy-+-routing-behavior)  Policy + routing behavior
...
## [​](https://docs.openclaw.ai/gateway/tools-invoke-http-api\#responses)  Responses
...
## [​](https://docs.openclaw.ai/gateway/tools-invoke-http-api\#example)  Example
...
[Openai http api](https://docs.openclaw.ai/gateway/openai-http-api) [Cli backends](https://docs.openclaw.ai/gateway/cli-backends)
