...
- [Agent Loop (OpenClaw)](https://docs.openclaw.ai/concepts/agent-loop#agent-loop-openclaw)
...
# [​](https://docs.openclaw.ai/concepts/agent-loop\#agent-loop-openclaw)  Agent Loop (OpenClaw)
...
See [Hooks](https://docs.openclaw.ai/hooks) for setup and examples.
...
See [Plugins](https://docs.openclaw.ai/plugin#plugin-hooks) for the hook API and registration details.
...
[Agent](https://docs.openclaw.ai/concepts/agent) [System prompt](https://docs.openclaw.ai/concepts/system-prompt)
