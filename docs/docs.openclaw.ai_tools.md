...
# [​](https://docs.openclaw.ai/tools\#tools-openclaw)  Tools (OpenClaw)
...
## [​](https://docs.openclaw.ai/tools\#disabling-tools)  Disabling tools
...
## [​](https://docs.openclaw.ai/tools\#tool-profiles-base-allowlist)  Tool profiles (base allowlist)
...
## [​](https://docs.openclaw.ai/tools\#provider-specific-tool-policy)  Provider-specific tool policy
...
## [​](https://docs.openclaw.ai/tools\#tool-groups-shorthands)  Tool groups (shorthands)
...
## [​](https://docs.openclaw.ai/tools\#plugins-+-tools)  Plugins + tools

Plugins can register **additional tools** (and CLI commands) beyond the core set.
See [Plugins](https://docs.openclaw.ai/plugin) for install + config, and [Skills](https://docs.openclaw.ai/tools/skills) for how
...
## [​](https://docs.openclaw.ai/tools\#tool-inventory)  Tool inventory

### [​](https://docs.openclaw.ai/tools\#apply_patch)  `apply_patch`

Apply structured patches across one or more files. Use for multi-hunk edits.
Experimental: enable via `tools.exec.applyPatch.enabled` (OpenAI models only).

### [​](https://docs.openclaw.ai/tools\#exec)  `exec`
...
### [​](https://docs.openclaw.ai/tools\#process)  `process`
...
### [​](https://docs.openclaw.ai/tools\#web_search)  `web_search`
...
### [​](https://docs.openclaw.ai/tools\#web_fetch)  `web_fetch`
...
### [​](https://docs.openclaw.ai/tools\#browser)  `browser`
...
### [​](https://docs.openclaw.ai/tools\#canvas)  `canvas`
...
### [​](https://docs.openclaw.ai/tools\#nodes)  `nodes`
...
### [​](https://docs.openclaw.ai/tools\#image)  `image`
...
### [​](https://docs.openclaw.ai/tools\#message)  `message`
...
### [​](https://docs.openclaw.ai/tools\#cron)  `cron`
...
### [​](https://docs.openclaw.ai/tools\#gateway)  `gateway`
...
### [​](https://docs.openclaw.ai/tools\#sessions_list-/-sessions_history-/-sessions_send-/-sessions_spawn-/-session_status)  `sessions_list` / `sessions_history` / `sessions_send` / `sessions_spawn` / `session_status`
...
### [​](https://docs.openclaw.ai/tools\#agents_list)  `agents_list`
...
## [​](https://docs.openclaw.ai/tools\#parameters-common)  Parameters (common)
...
## [​](https://docs.openclaw.ai/tools\#recommended-agent-flows)  Recommended agent flows
...
## [​](https://docs.openclaw.ai/tools\#safety)  Safety

- Avoid direct `system.run`; use `nodes` → `run` only with explicit user consent.
- Respect user consent for camera/screen capture.
- Use `status/describe` to ensure permissions before invoking media commands.

## [​](https://docs.openclaw.ai/tools\#how-tools-are-presented-to-the-agent)  How tools are presented to the agent
...
[Poll](https://docs.openclaw.ai/automation/poll) [Lobster](https://docs.openclaw.ai/tools/lobster)
