...
- [Model providers](https://docs.openclaw.ai/concepts/model-providers#model-providers)
...
- [OpenAI Code (Codex)](https://docs.openclaw.ai/concepts/model-providers#openai-code-codex)
- [OpenCode Zen](https://docs.openclaw.ai/concepts/model-providers#opencode-zen)
- [Google Gemini (API key)](https://docs.openclaw.ai/concepts/model-providers#google-gemini-api-key)
- [Google Vertex / Antigravity / Gemini CLI](https://docs.openclaw.ai/concepts/model-providers#google-vertex-%2F-antigravity-%2F-gemini-cli)
...
- [Other built-in providers](https://docs.openclaw.ai/concepts/model-providers#other-built-in-providers)
...
- [Qwen OAuth (free tier)](https://docs.openclaw.ai/concepts/model-providers#qwen-oauth-free-tier)
...
- [Local proxies (LM Studio, vLLM, LiteLLM, etc.)](https://docs.openclaw.ai/concepts/model-providers#local-proxies-lm-studio%2C-vllm%2C-litellm%2C-etc)
- [CLI examples](https://docs.openclaw.ai/concepts/model-providers#cli-examples)

# [​](https://docs.openclaw.ai/concepts/model-providers\#model-providers)  Model providers

This page covers **LLM/model providers** (not chat channels like WhatsApp/Telegram).
For model selection rules, see [/concepts/models](https://docs.openclaw.ai/concepts/models).
...
### [​](https://docs.openclaw.ai/concepts/model-providers\#openai-code-codex)  OpenAI Code (Codex)
...
### [​](https://docs.openclaw.ai/concepts/model-providers\#opencode-zen)  OpenCode Zen
...
### [​](https://docs.openclaw.ai/concepts/model-providers\#google-vertex-/-antigravity-/-gemini-cli)  Google Vertex / Antigravity / Gemini CLI
...
### [​](https://docs.openclaw.ai/concepts/model-providers\#other-built-in-providers)  Other built-in providers
...
## [​](https://docs.openclaw.ai/concepts/model-providers\#providers-via-models-providers-custom/base-url)  Providers via `models.providers` (custom/base URL)
...
### [​](https://docs.openclaw.ai/concepts/model-providers\#qwen-oauth-free-tier)  Qwen OAuth (free tier)
...
[Retry](https://docs.openclaw.ai/concepts/retry) [Models](https://docs.openclaw.ai/concepts/models)
