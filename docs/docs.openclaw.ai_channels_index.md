...
# [​](https://docs.openclaw.ai/channels/index\#chat-channels)  Chat Channels

OpenClaw can talk to you on any chat app you already use. Each channel connects via the Gateway.
Text is supported everywhere; media and reactions vary by channel.

## [​](https://docs.openclaw.ai/channels/index\#supported-channels)  Supported channels
...
## [​](https://docs.openclaw.ai/channels/index\#notes)  Notes
