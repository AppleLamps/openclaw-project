...
[Skip to main content](https://docs.openclaw.ai/platforms/mac/remote#content-area)
...
- [Remote OpenClaw (macOS ⇄ remote host)](https://docs.openclaw.ai/platforms/mac/remote#remote-openclaw-macos-%E2%87%84-remote-host)
- [Modes](https://docs.openclaw.ai/platforms/mac/remote#modes)
- [Remote transports](https://docs.openclaw.ai/platforms/mac/remote#remote-transports)
- [Prereqs on the remote host](https://docs.openclaw.ai/platforms/mac/remote#prereqs-on-the-remote-host)
- [macOS app setup](https://docs.openclaw.ai/platforms/mac/remote#macos-app-setup)
- [Web Chat](https://docs.openclaw.ai/platforms/mac/remote#web-chat)
- [Permissions](https://docs.openclaw.ai/platforms/mac/remote#permissions)
- [Security notes](https://docs.openclaw.ai/platforms/mac/remote#security-notes)
- [WhatsApp login flow (remote)](https://docs.openclaw.ai/platforms/mac/remote#whatsapp-login-flow-remote)
- [Troubleshooting](https://docs.openclaw.ai/platforms/mac/remote#troubleshooting)
- [Notification sounds](https://docs.openclaw.ai/platforms/mac/remote#notification-sounds)

# [​](https://docs.openclaw.ai/platforms/mac/remote\#remote-openclaw-macos-%E2%87%84-remote-host)  Remote OpenClaw (macOS ⇄ remote host)
...
## [​](https://docs.openclaw.ai/platforms/mac/remote\#modes)  Modes
...
## [​](https://docs.openclaw.ai/platforms/mac/remote\#remote-transports)  Remote transports
...
## [​](https://docs.openclaw.ai/platforms/mac/remote\#prereqs-on-the-remote-host)  Prereqs on the remote host
...
## [​](https://docs.openclaw.ai/platforms/mac/remote\#macos-app-setup)  macOS app setup
...
## [​](https://docs.openclaw.ai/platforms/mac/remote\#web-chat)  Web Chat
...
## [​](https://docs.openclaw.ai/platforms/mac/remote\#permissions)  Permissions
...
## [​](https://docs.openclaw.ai/platforms/mac/remote\#security-notes)  Security notes
...
## [​](https://docs.openclaw.ai/platforms/mac/remote\#whatsapp-login-flow-remote)  WhatsApp login flow (remote)

- Run `openclaw channels login --verbose` **on the remote host**. Scan the QR with WhatsApp on your phone.
- Re-run login on that host if auth expires. Health check will surface link problems.

## [​](https://docs.openclaw.ai/platforms/mac/remote\#troubleshooting)  Troubleshooting
...
## [​](https://docs.openclaw.ai/platforms/mac/remote\#notification-sounds)  Notification sounds
...
[Permissions](https://docs.openclaw.ai/platforms/mac/permissions) [Signing](https://docs.openclaw.ai/platforms/mac/signing)
