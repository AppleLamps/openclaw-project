...
- [Models CLI](https://docs.openclaw.ai/concepts/models#models-cli)
- [How model selection works](https://docs.openclaw.ai/concepts/models#how-model-selection-works)
- [Quick model picks (anecdotal)](https://docs.openclaw.ai/concepts/models#quick-model-picks-anecdotal)
- [Setup wizard (recommended)](https://docs.openclaw.ai/concepts/models#setup-wizard-recommended)
- [Config keys (overview)](https://docs.openclaw.ai/concepts/models#config-keys-overview)
- [“Model is not allowed” (and why replies stop)](https://docs.openclaw.ai/concepts/models#%E2%80%9Cmodel-is-not-allowed%E2%80%9D-and-why-replies-stop)
...
# [​](https://docs.openclaw.ai/concepts/models\#models-cli)  Models CLI

See [/concepts/model-failover](https://docs.openclaw.ai/concepts/model-failover) for auth profile
rotation, cooldowns, and how that interacts with fallbacks.
Quick provider overview + examples: [/concepts/model-providers](https://docs.openclaw.ai/concepts/model-providers).
...
## [​](https://docs.openclaw.ai/concepts/models\#quick-model-picks-anecdotal)  Quick model picks (anecdotal)

- **GLM**: a bit better for coding/tool calling.
- **MiniMax**: better for writing and vibes.

## [​](https://docs.openclaw.ai/concepts/models\#setup-wizard-recommended)  Setup wizard (recommended)
...
to `zai/*`.Provider configuration examples (including OpenCode Zen) live in
[/gateway/configuration](https://docs.openclaw.ai/gateway/configuration#opencode-zen-multi-model-proxy).

## [​](https://docs.openclaw.ai/concepts/models\#%E2%80%9Cmodel-is-not-allowed%E2%80%9D-and-why-replies-stop)  “Model is not allowed” (and why replies stop)
...
Use `--check` for automation (exit `1` when missing/expired, `2` when expiring).Preferred Anthropic auth is the Claude Code CLI setup-token (run anywhere; paste on the gateway host if needed):
...
optionally probe models for tool and image support.Key flags:
...
`OPENROUTER_API_KEY`). Without a key, use `--no-probe` to list candidates only.Scan results are ranked by:
...
- Requires OpenRouter API key from auth profiles or `OPENROUTER_API_KEY` (see [/environment](https://docs.openclaw.ai/environment))
...
[Model providers](https://docs.openclaw.ai/concepts/model-providers) [Model failover](https://docs.openclaw.ai/concepts/model-failover)
