...
[Skip to main content](https://docs.openclaw.ai/platforms/mac/icon#content-area)
...
- [Menu Bar Icon States](https://docs.openclaw.ai/platforms/mac/icon#menu-bar-icon-states)

# [​](https://docs.openclaw.ai/platforms/mac/icon\#menu-bar-icon-states)  Menu Bar Icon States
...
[Health](https://docs.openclaw.ai/platforms/mac/health) [Logging](https://docs.openclaw.ai/platforms/mac/logging)
