...
- [Gateway CLI](https://docs.openclaw.ai/cli/gateway#gateway-cli)
...
# [​](https://docs.openclaw.ai/cli/gateway\#gateway-cli)  Gateway CLI
...
[Approvals](https://docs.openclaw.ai/cli/approvals) [Tui](https://docs.openclaw.ai/cli/tui)
