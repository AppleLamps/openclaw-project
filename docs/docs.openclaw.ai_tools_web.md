...
- [Requirements](https://docs.openclaw.ai/tools/web#requirements-2)
- [Config](https://docs.openclaw.ai/tools/web#config-2)
- [Tool parameters](https://docs.openclaw.ai/tools/web#tool-parameters-2)
...
### [​](https://docs.openclaw.ai/tools/web\#requirements-2)  Requirements

- `tools.web.fetch.enabled` must not be `false` (default: enabled)
- Optional Firecrawl fallback: set `tools.web.fetch.firecrawl.apiKey` or `FIRECRAWL_API_KEY`.

### [​](https://docs.openclaw.ai/tools/web\#config-2)  Config
...
### [​](https://docs.openclaw.ai/tools/web\#tool-parameters-2)  Tool parameters
...
[Exec](https://docs.openclaw.ai/tools/exec) [Apply patch](https://docs.openclaw.ai/tools/apply-patch)
