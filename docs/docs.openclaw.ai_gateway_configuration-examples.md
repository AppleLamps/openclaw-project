...
- [Configuration Examples](https://docs.openclaw.ai/gateway/configuration-examples#configuration-examples)
...
- [OAuth with API key failover](https://docs.openclaw.ai/gateway/configuration-examples#oauth-with-api-key-failover)
- [Anthropic subscription + API key, MiniMax fallback](https://docs.openclaw.ai/gateway/configuration-examples#anthropic-subscription-%2B-api-key%2C-minimax-fallback)
...
# [​](https://docs.openclaw.ai/gateway/configuration-examples\#configuration-examples)  Configuration Examples
...
### [​](https://docs.openclaw.ai/gateway/configuration-examples\#oauth-with-api-key-failover)  OAuth with API key failover
...
### [​](https://docs.openclaw.ai/gateway/configuration-examples\#anthropic-subscription-+-api-key,-minimax-fallback)  Anthropic subscription + API key, MiniMax fallback
...
- See [Providers](https://docs.openclaw.ai/channels/whatsapp) and [Troubleshooting](https://docs.openclaw.ai/gateway/troubleshooting) for deeper setup notes.

[Multiple gateways](https://docs.openclaw.ai/gateway/multiple-gateways) [Authentication](https://docs.openclaw.ai/gateway/authentication)
