...
## [​](https://docs.openclaw.ai/automation/cron-jobs\#tl;dr)  TL;DR
...
[Gmail pubsub](https://docs.openclaw.ai/automation/gmail-pubsub) [Cron vs heartbeat](https://docs.openclaw.ai/automation/cron-vs-heartbeat)
