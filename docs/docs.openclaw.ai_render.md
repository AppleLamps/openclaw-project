---
url: "https://docs.openclaw.ai/render"
title: "Deploy on Render - OpenClaw"
---

[Skip to main content](https://docs.openclaw.ai/render#content-area)
...
- [Prerequisites](https://docs.openclaw.ai/render#prerequisites)
- [Deploy with a Render Blueprint](https://docs.openclaw.ai/render#deploy-with-a-render-blueprint)
- [Understanding the Blueprint](https://docs.openclaw.ai/render#understanding-the-blueprint)
- [Choosing a plan](https://docs.openclaw.ai/render#choosing-a-plan)
- [After deployment](https://docs.openclaw.ai/render#after-deployment)
- [Complete the setup wizard](https://docs.openclaw.ai/render#complete-the-setup-wizard)
- [Access the Control UI](https://docs.openclaw.ai/render#access-the-control-ui)
- [Render Dashboard features](https://docs.openclaw.ai/render#render-dashboard-features)
- [Logs](https://docs.openclaw.ai/render#logs)
- [Shell access](https://docs.openclaw.ai/render#shell-access)
- [Environment variables](https://docs.openclaw.ai/render#environment-variables)
- [Auto-deploy](https://docs.openclaw.ai/render#auto-deploy)
- [Custom domain](https://docs.openclaw.ai/render#custom-domain)
- [Scaling](https://docs.openclaw.ai/render#scaling)
- [Backups and migration](https://docs.openclaw.ai/render#backups-and-migration)
- [Troubleshooting](https://docs.openclaw.ai/render#troubleshooting)
- [Service won’t start](https://docs.openclaw.ai/render#service-won%E2%80%99t-start)
- [Slow cold starts (free tier)](https://docs.openclaw.ai/render#slow-cold-starts-free-tier)
- [Data loss after redeploy](https://docs.openclaw.ai/render#data-loss-after-redeploy)
- [Health check failures](https://docs.openclaw.ai/render#health-check-failures)
...
## [​](https://docs.openclaw.ai/render\#prerequisites)  Prerequisites

- A [Render account](https://render.com/) (free tier available)
- An API key from your preferred [model provider](https://docs.openclaw.ai/providers)

## [​](https://docs.openclaw.ai/render\#deploy-with-a-render-blueprint)  Deploy with a Render Blueprint
...
## [​](https://docs.openclaw.ai/render\#understanding-the-blueprint)  Understanding the Blueprint
...
## [​](https://docs.openclaw.ai/render\#choosing-a-plan)  Choosing a plan
...
## [​](https://docs.openclaw.ai/render\#after-deployment)  After deployment

### [​](https://docs.openclaw.ai/render\#complete-the-setup-wizard)  Complete the setup wizard
...
### [​](https://docs.openclaw.ai/render\#access-the-control-ui)  Access the Control UI

The web dashboard is available at `https://<your-service>.onrender.com/openclaw`.

## [​](https://docs.openclaw.ai/render\#render-dashboard-features)  Render Dashboard features

### [​](https://docs.openclaw.ai/render\#logs)  Logs
...
## [​](https://docs.openclaw.ai/render\#custom-domain)  Custom domain
...
## [​](https://docs.openclaw.ai/render\#scaling)  Scaling
...
## [​](https://docs.openclaw.ai/render\#backups-and-migration)  Backups and migration
...
## [​](https://docs.openclaw.ai/render\#troubleshooting)  Troubleshooting

### [​](https://docs.openclaw.ai/render\#service-won%E2%80%99t-start)  Service won’t start
...
### [​](https://docs.openclaw.ai/render\#slow-cold-starts-free-tier)  Slow cold starts (free tier)
...
### [​](https://docs.openclaw.ai/render\#data-loss-after-redeploy)  Data loss after redeploy

This happens on free tier (no persistent disk). Upgrade to a paid plan, or
regularly export your config via `/setup/export`.

### [​](https://docs.openclaw.ai/render\#health-check-failures)  Health check failures
...
[Deploy on Railway](https://docs.openclaw.ai/railway) [Deploy on Northflank](https://docs.openclaw.ai/northflank)
