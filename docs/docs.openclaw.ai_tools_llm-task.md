...
- [Example: Lobster workflow step](https://docs.openclaw.ai/tools/llm-task#example%3A-lobster-workflow-step)
...
[Lobster](https://docs.openclaw.ai/tools/lobster) [Plugin](https://docs.openclaw.ai/plugin)
