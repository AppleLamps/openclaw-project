...
- [⚠️ Safety first](https://docs.openclaw.ai/start/openclaw#%E2%9A%A0%EF%B8%8F-safety-first)
...
## [​](https://docs.openclaw.ai/start/openclaw\#%E2%9A%A0%EF%B8%8F-safety-first)  ⚠️ Safety first
...
Now message the assistant number from your allowlisted phone.When onboarding finishes, we auto-open the dashboard with your gateway token and print the tokenized link. To reopen later: `openclaw dashboard`.
...
[Pairing](https://docs.openclaw.ai/start/pairing) [Showcase](https://docs.openclaw.ai/start/showcase)
